...
\geometry{left=1.2cm,right=1.2cm,top=1.2cm,bottom=0.5cm} 
...
\begin{tikzpicture}[remember picture,overlay]
\node[anchor=south west,inner sep=3pt,opacity=.3] at (current page.south west)
{\includegraphics[width=.1\textwidth]{Rohdaten/Bilder/Schneegloeckchen.png}};
\end{tikzpicture}
\begin{tikzpicture}[remember picture,overlay]
\node[anchor=north,inner sep=5pt] at (current page.north)
{\includegraphics[width=.35\textwidth]{Rohdaten/Bilder/ueberschrift.png}};
\end{tikzpicture}
%\vspace{-2.7cm}
%\begin{figure}[H]
%\center
