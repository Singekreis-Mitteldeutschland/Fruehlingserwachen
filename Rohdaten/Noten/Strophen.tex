...
Sie \chort{(d)}{dreht} an den \chort{C}{Wir}beln und \chort{G}{spielt} eine \chort{a/E}{Rund'}. ~:$\|$

\textbf{3.} Das \chort{a}{Sing}en mit \chort{C}{Freund}en ist \chort{G}{Le}bens\chort{a}{freu}de, musi\chort{C}{zie}ren \chort{G}{liebt} sie so \chort{a}{sehr}: \\
...
\chort{(d)}{tan}zen, lachen \chort{C}{sing}en ist \chort{G}{al}les ge\chort{a/E}{sund}. ~:$\|$

\textbf{4.} \chort{a}{Nacht} bricht \chort{C}{ein}, die \chort{G}{Nach}tigall \chort{a}{schlägt} und im \chort{C}{Zelt} der \chort{G}{Schlaf}sack be\chort{a}{reit}; \\
...
\textbf{Schluss:} \chort{a}{Wenn} die \chort{C}{ers}ten \chort{G}{Blü}ten sich \chort{a}{öff}nen und der \chort{E}{Wind} leise \chort{a}{weht}...
